...
function Home() {
  ...
  return (
    <MainLayout>
      {!isLoggedIn && <section className="welcome-section"> 
        ...
        <ul>
          <li className="welcome-section__list-item">Create your profile and build a personal gallery with the images that inspire you most;</li>
          <li className="welcome-section__list-item">Read accessible explanations, adapted so anyone can understand, even without a background in astronomy;</li>
          <li className="welcome-section__list-item">Explore the full archive of previous days and see how the sky has changed over time;</li>
          <li className="welcome-section__list-item">Rediscover the universe, day by day, with breathtaking images and stories behind each one.</li>
        </ul>
        <p className="welcome-section__paragraph">With AstroGallery, every day is a new chance to be amazed by the universe.</p>
        <Link to="/" className="welcome-section__paragraph"><p>Start now</p></Link>
      </section> }
